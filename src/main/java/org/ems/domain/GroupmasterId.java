...
/**
 * GroupmasterId generated by hbm2java
 */
@Embeddable

public class GroupmasterId
 {
    ...
    public GroupmasterId() {
    }

    public GroupmasterId(String organizationid, String groupcode) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof GroupmasterId) ) return false;
		 GroupmasterId castOther = ( GroupmasterId ) other; 
